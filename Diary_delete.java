...
public class Diary_delete {
	 ...
	 */
	public static void Diary_delete_screen(String id) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Diary_delete window = new Diary_delete(id);
	...
	private void initialize(String id) {
		...
		btnNewButton.setFont(new Font("210 맨발의청춘 R", Font.PLAIN, 13));
		btnNewButton.setBounds(495, 73, 87, 29);
		...
		JButton btnNewButton_1 = new JButton("\uC0AD\uC81C\uC644\uB8CC\u221A");
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
	            ...
	            if (!select.equals("선택")) {
	               sql.DeleteDiary("diary", id, select);
		...
		btnNewButton_1.setFont(new Font("210 맨발의청춘 R", Font.PLAIN, 18));
		btnNewButton_1.setBounds(457, 106, 125, 36);
		frame.getContentPane().add(btnNewButton_1);
		
		
		label_1.setIcon(new ImageIcon(Diary_delete.class.getResource("/images/back.gif")));
